    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 59.0, middle: 0.7814),
            Pin(size: 22.0, middle: 0.3246),
            child: Text(
              'Guests: ',
              style: TextStyle(
                fontFamily: 'Gibson',
          ...
          Pinned.fromPins(
            Pin(size: 18.0, end: 50.1),
            Pin(size: 20.0, middle: 0.3234),
          ...
          Pinned.fromPins(
            Pin(size: 95.0, end: 25.5),
            Pin(size: 28.0, middle: 0.3562),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(14.0),
                color: const Color(0x08ffffff),
                border: Border.all(width: 1.0, color: const Color(0x08000000)),
              ),
            ),
          ),
          Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 18.0, end: 41.4),
            Pin(size: 20.0, middle: 0.5068),
            child: Transform.rotate(
              angle: -0.9076,
              child: Container(
                decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 96.0, middle: 0.5185),
            Pin(size: 68.0, end: 31.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
...
const String _svg_kyp2mu =
    '<svg viewBox="-1.0 744.0 394.0 84.0" ><path transform="translate(-1.0, 744.0)" d="M 12 0 L 369.3180541992188 0 L 382 0 C 388.6274108886719 0 394 5.37258243560791 394 12 L 394 84 L 0 84 L 0 12 C 0 5.37258243560791 5.37258243560791 0 12 0 Z" fill="#2a2e43" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
