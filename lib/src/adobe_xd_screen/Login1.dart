      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'Lobby2_1v2' (shape)
                Container(
          ...
          Pinned.fromPins(
            Pin(start: 26.0, end: 41.0),
            Pin(size: 25.0, middle: 0.2032),
            child: Text(
              'Venue Reservation System',
              style: TextStyle(
                fontFamily: 'Times New Roman',
                fontSize: 23,
                color: const Color(0xc94531fe),
          ...
          Pinned.fromPins(
            Pin(size: 84.0, middle: 0.5016),
            Pin(size: 22.0, middle: 0.2835),
            child: Text(
              'Sign Up',
              style: TextStyle(
                fontFamily: 'Times New Roman',
          ...
          Pinned.fromPins(
            Pin(size: 290.0, start: 42.0),
            Pin(size: 16.0, middle: 0.7928),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 103.0, middle: 0.5017),
            Pin(size: 38.0, end: 59.8),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 11.0, middle: 0.5838),
            Pin(size: 12.0, middle: 0.3182),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            Pin(size: 92.0, middle: 0.4352),
            Pin(size: 20.0, middle: 0.3153),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 208.0, middle: 0.5189),
            Pin(size: 16.0, middle: 0.6383),
            child: Text.rich(
              TextSpan(
                style: TextStyle(
                  fontFamily: 'Times New Roman',
          ...
          Pinned.fromPins(
            Pin(size: 17.0, middle: 0.1755),
            Pin(size: 17.0, middle: 0.6415),
            child: BlendMask(
