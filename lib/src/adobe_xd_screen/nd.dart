    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 15.6, start: 25.6),
            Pin(size: 11.8, end: 128.4),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 93.0, start: 51.0),
            Pin(size: 27.0, end: 122.0),
            child: Text(
              'Bonomaya',
              style: TextStyle(
                fontFamily: 'Gibson',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 21.0, end: 118.0),
            child: Text(
              'Booked',
              style: TextStyle(
                fontFamily: 'Gibson',
                fontSize: 16,
                color: const Color(0x80634554),
                fontWeight: FontWeight.w600,
              ),
              textAlign: TextAlign.left,
            ),
          ...
          Pinned.fromPins(
            Pin(size: 17.0, middle: 0.4495),
            Pin(size: 17.0, end: 125.0),
            child: Text(
              '4.7',
              style: TextStyle(
                fontFamily: 'Gibson',
          ...
          Pinned.fromPins(
            Pin(size: 8.0, middle: 0.4104),
            Pin(size: 10.0, end: 127.0),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
...
const String _svg_i659w =
    '<svg viewBox="0.0 699.9 394.0 84.0" ><path transform="translate(0.0, 699.9)" d="M 12 0 L 369.3180541992188 0 L 382 0 C 388.6274108886719 0 394 5.37258243560791 394 12 L 394 84 L 0 84 L 0 12 C 0 5.37258243560791 5.37258243560791 0 12 0 Z" fill="#2a2e43" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_xuisy =
    '<svg viewBox="21.0 724.6 12.8 9.0" ><path transform="translate(18.5, 718.58)" d="M 14.34189701080322 14.81727886199951 C 14.57523441314697 15.11872577667236 14.92524147033691 15.11872577667236 15.15857982635498 14.81727886199951 C 15.39191722869873 14.51583385467529 15.39191722869873 14.06366443634033 15.15857982635498 13.76222038269043 L 9.325132369995117 6.22608470916748 C 9.091794967651367 5.924639701843262 8.741787910461426 5.924639701843262 8.508449554443359 6.22608470916748 L 2.675002336502075 13.76222038269043 C 2.441664457321167 14.06366443634033 2.441664457321167 14.51583385467529 2.675002336502075 14.81727886199951 C 2.908340454101562 15.11872577667236 3.258347272872925 15.11872577667236 3.491684913635254 14.81727886199951 L 8.916790962219238 7.808672904968262 L 14.34189701080322 14.81727886199951 L 14.34189701080322 14.81727886199951 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
