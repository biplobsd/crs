...
class rd6 extends StatelessWidget {
  rd6({
    Key key,
  }) : super(key: key);
  @override
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(size: 175.0, middle: 0.4588),
                        Pin(size: 22.0, middle: 0.4514),
                        child: Text(
                          'Payment: \$2 /Per Ticket',
                          style: TextStyle(
                            fontFamily: 'Gibson',
                            fontSize: 17,
                            color: const Color(0xffffffff),
