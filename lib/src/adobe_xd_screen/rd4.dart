...
class rd4 extends StatelessWidget {
  rd4({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 29.0, middle: 0.7637),
            Pin(size: 33.0, middle: 0.5416),
            child: Container(
              decoration: BoxDecoration(
            ...
            child: PageLink(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 28.0, middle: 0.5205),
                    Pin(size: 16.0, middle: 0.2647),
                    child: Text(
                      'Event',
                      style: TextStyle(
                        fontFamily: 'Gibson',
          ...
          Pinned.fromPins(
            Pin(size: 40.0, end: 13.0),
            Pin(size: 40.0, middle: 0.7115),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
